...
//    break;
    ...
    printf("\n saisieChoix vaut : %d", saisieChoix);
    return saisieChoix;
    //à quoi ça sert de renvoyer saisieChoix ?
}
...
void menuTourDeJeu(char NOMSDESJOUEURS[4][15])
{
    int choixMenu = 0;
    int saisieChoix = 0;
    //à quoi sert saisieChoix dans cette fonction ?  Il faudrait utiliser le même nom dans les 2 fonctions : soit choixMenu soit saisieChoix.  saisieChoix me semble mieux
